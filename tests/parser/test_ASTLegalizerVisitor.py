...
class TestASTLegalizer(unittest.TestCase):
    ...
    def test_visit_ir_move_value_register_to_register(self):
        ...
        move_node = IRMoveValue(src=src_reg, dest=dest_reg)
        
        self.legalizer.visit_ir_move_value(move_node, self.instructions)
    ...
    def test_visit_ir_move_value_register_to_stack(self):
        """Test move from register to stack (legal operation)."""
        src_reg = Register(value=RegisterEnum.EAX)
        dest_stack = Stack(offset=-4)
        move_node = IRMoveValue(src=src_reg, dest=dest_stack)
    ...
    def test_visit_ir_move_value_stack_to_register(self):
        ...
        dest_reg = Register(value=RegisterEnum.R10)
        move_node = IRMoveValue(src=src_stack, dest=dest_reg)
    ...
    def test_visit_ir_move_value_stack_to_stack_illegal(self):
        ...
        self.assertIsInstance(self.instructions[1], IRMoveValue)
    ...
    def test_visit_ir_move_value_pseudo_to_pseudo(self):
        ...
        move_node = IRMoveValue(src=pseudo1, dest=pseudo2)
    ...
    def test_visit_ir_move_value_pseudo_to_register(self):
        """Test move from pseudo to register."""
        pseudo = self.allocator.allocate_pseudo("tmp.1")
        dest_reg = Register(value=RegisterEnum.EAX)
        move_node = IRMoveValue(src=pseudo, dest=dest_reg)
    ...
    def test_multiple_stack_to_stack_moves(self):
        ...
        move1 = IRMoveValue(src=stack1, dest=stack2)
        move2 = IRMoveValue(src=stack2, dest=stack3)
        
        self.legalizer.visit_ir_move_value(move1, self.instructions)
        self.legalizer.visit_ir_move_value(move2, self.instructions)
